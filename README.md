...
This repository contains sample to set a graphical frame image as a background of the [Syncfusion .NET MAUI Radial Gauge](https://help.syncfusion.com/maui/radial-gauge/getting-started) control.
